import { StoEmailTexts, emailTexts, EmailTexts } from './email-texts.service';
...
export const validateEmailTextsInputVM = (o: EmailTextsInputVM): void => {
  const { stoid, emailTitle } = o;
  if (stoid === null || stoid === undefined) throw new Error(`Validation: Invalid stoid:${stoid}`);
