...
contract ERC1404TokenMinKYC is IERC20Token, IERC1404 {
	...
	returns (uint8 status)
    {
		  ...
		  require( _sellRestriction[_from] != 0  && _buyRestriction[_to] != 0, "KYC Time Restriction 0" );
	...
	returns (bool)
	{
        require(_allowances[msg.sender][sender] >= amount, "Amount cannot be greater than Allowance" );
