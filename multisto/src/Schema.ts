...
/**
 * Exposes all fields present in autoCryptoPaymentReceiptProcessing as a typescript
 * interface.
 */
export interface AutoCryptoPaymentReceiptProcessing {
  id: number;
  investorId?: number | null;
  Details?: string | null;
  AmountReceived: number;
  CryptoCoinID?: number | null;
  stoId: number;
...
/**
 * Exposes the same fields as AutoCryptoPaymentReceiptProcessing,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface AutoCryptoPaymentReceiptProcessingWithDefaults {
  id?: number;
  investorId?: number | null;
  Details?: string | null;
  AmountReceived: number;
...
/**
 * Exposes all fields present in blockchains as a typescript
 * interface.
 */
...
/**
 * Exposes the same fields as Blockchains,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface BlockchainsWithDefaults {
  id?: number;
  title?: string | null;
}
/**
...
export interface DividendPayouts {
  ...
  currentlyPaidAmount: number;
  /**  Defaults to: 0. */
  currentlyPaidInvestors: number;
  adminId?: number | null;
}
...
export interface Documentfields {
  ...
  externalFileDataLabel?: string | null;
}
...
export interface Documents {
  ...
  helloSignDocumentID?: string | null;
}
...
/**
 * Exposes all fields present in EmailTextOverrides as a typescript
 * interface.
 */
export interface EmailTextOverrides {
  ID: number;
  /**  Defaults to: 0. */
  stoID: number;
  /**  Defaults to: en. */
...
/**
 * Exposes the same fields as EmailTextOverrides,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface EmailTextOverridesWithDefaults {
  ID?: number;
  /**  Defaults to: 0. */
  stoID?: number;
  /**  Defaults to: en. */
...
export interface FeeCommissions {
  ...
  beneficiaryType?: "BROKER" | "INVESTOR" | null;
}
...
/**
 * Exposes all fields present in investing_entity_types as a typescript
 * interface.
 */
export interface InvestingEntityTypes {
  ID: number;
  title: string;
  countries: string;
}
...
/**
 * Exposes the same fields as InvestingEntityTypes,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface InvestingEntityTypesWithDefaults {
  ID?: number;
  title: string;
  countries: string;
}
...
export interface Investor {
  ...
  /**  Defaults to: CURRENT_TIMESTAMP. */
  investmentLimitUpdateDate: Date;
  /**  Defaults to: 0. */
...
/**
 * Exposes all fields present in InvestorInvoices as a typescript
 * interface.
 */
export interface InvestorInvoices {
  ID: number;
  investorID: number;
  shareTypeID: number;
  stoID: number;
...
/**
 * Exposes the same fields as InvestorInvoices,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface InvestorInvoicesWithDefaults {
  ID?: number;
  investorID: number;
  shareTypeID: number;
  stoID: number;
...
/**
 * Exposes all fields present in investor_brokers as a typescript
 * interface.
 */
export interface InvestorBrokers {
  ID: number;
  investorID: number;
  brokerID: string;
}
...
/**
 * Exposes the same fields as InvestorBrokers,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface InvestorBrokersWithDefaults {
  ID?: number;
  investorID: number;
  brokerID: string;
}
...
/**
 * Exposes all fields present in MoonpayBuyAlerts as a typescript
 * interface.
 */
export interface MoonpayBuyAlerts {
  transactionID: number;
  alertID: number;
}

/**
 * Exposes the same fields as MoonpayBuyAlerts,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface MoonpayBuyAlertsWithDefaults {
  transactionID: number;
  alertID: number;
}
/**
 * Exposes all fields present in MoonpayTransactionData as a typescript
 * interface.
 */
...
/**
 * Exposes the same fields as MoonpayTransactionData,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface MoonpayTransactionDataWithDefaults {
  ID?: number;
  rawData: string;
  salt: string;
  objectType: string;
...
/**
 * Exposes all fields present in netki_access_codes as a typescript
 * interface.
 */
export interface NetkiAccessCodes {
  access_code: string;
  investorID?: number | null;
...
/**
 * Exposes the same fields as NetkiAccessCodes,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface NetkiAccessCodesWithDefaults {
  access_code: string;
  investorID?: number | null;
  childAccessCode?: string | null;
}
...
export interface Paymentchannels {
  ...
  adminEmailHeader?: string | null;
  adminEmailBody?: string | null;
  /**  Defaults to: 1. */
  sendAdminEmail: number;
}
...
/**
 * Exposes all fields present in ravencoinPublicAddresses as a typescript
 * interface.
 */
export interface RavencoinPublicAddresses {
  id: number;
  publicKey?: string | null;
}

/**
 * Exposes the same fields as RavencoinPublicAddresses,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface RavencoinPublicAddressesWithDefaults {
  id?: number;
  publicKey?: string | null;
}
/**
...
/**
 * Exposes all fields present in sent_to_all_messages as a typescript
 * interface.
 */
export interface SentToAllMessages {
  adminID: number;
  /**  Defaults to: CURRENT_TIMESTAMP. */
  dateSent: Date;
  ID: number;
...
/**
 * Exposes the same fields as SentToAllMessages,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface SentToAllMessagesWithDefaults {
  adminID: number;
  /**  Defaults to: CURRENT_TIMESTAMP. */
  dateSent?: Date;
  ID?: number;
...
/**
 * Exposes all fields present in sharesHistoricalData as a typescript
 * interface.
 */
export interface SharesHistoricalData {
  ID: number;
  shareTypeID: number;
  stoID: number;
  premiumValue: number;
...
/**
 * Exposes the same fields as SharesHistoricalData,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface SharesHistoricalDataWithDefaults {
  ID?: number;
  shareTypeID: number;
  stoID: number;
  premiumValue: number;
...
/**
 * Exposes all fields present in shares_transfer_history as a typescript
 * interface.
 */
export interface SharesTransferHistory {
  ID: number;
  stoID: number;
  investorID: number;
  adminID: number;
...
/**
 * Exposes the same fields as SharesTransferHistory,
 * but makes every field containing a DEFAULT value optional.
 *
 * This is especially useful when generating inserts, as you
 * should be able to omit these fields if you'd like
 */
export interface SharesTransferHistoryWithDefaults {
  ID?: number;
  stoID: number;
  investorID: number;
  adminID: number;
...
export interface Sharetypes {
  ...
  /**  Defaults to: 1. */
  sellToCompany: number;
  /**  Defaults to: 0.0000000000000000. */
  sellValue: number;
  /**  Defaults to: 0. */
  isShareNosApplicable: number;
  /**  Defaults to: 0. */
  isCertificateNosApplicable: number;
  /**  Defaults to: -1. */
  channelIDForAutoPayments?: number | null;
  keyStoreFileAutoPayments?: string | null;
  keyStoreFileAutoPaymentsPassword?: string | null;
}
...
export interface Stos {
  ...
  helloSignClientID?: string | null;
  SMTP_FromName?: string | null;
  /**  Defaults to: CURRENT_TIMESTAMP. */
  createdAt: Date;
  /**  Defaults to: 0. */
  defaultBlockchain?: number | null;
}
